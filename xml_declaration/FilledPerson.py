...
class DocArchIdDetails(IXMLElement):
    ...
    def to_xml(self) -> ET.Element:
        elem = ET.Element('{urn:customs.ru:RUDeclCommonAggregateTypesCust:5.24.0}DocArchIdDetails')
...
class PowerOfAttorneyDetails(IXMLElement):
    ...
    def to_xml(self) -> ET.Element:
        elem = ET.Element('{urn:customs.ru:RUDeclCommonAggregateTypesCust:5.24.0}PowerOfAttorneyDetails')
